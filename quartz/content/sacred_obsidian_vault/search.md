<body>
 ...
 <p> </p>
 <h3 align="CENTER">Search Sacred-texts.com</h3>
 <hr>
 <span class="p-small-gray">
 <p>This box below allows you to search the full text of this site using Google:</p>
 <center>
 <!-- SiteSearch Google -->
 <form method="GET" action="https://www.google.com/custom">
 Search powered by
 <img src="https://www.google.com/logos/Logo_25wht.gif" border="0" alt="Google">
 <input type="hidden" name="domains" value="www.sacred-texts.com"><input type="text" name="q" size="32" maxlength="255" value=""><br>
 <p align="center">
 <input type="submit" name="sa" value="Search">
 </p>
 search:
 <input type="radio" name="sitesearch" value="www.sacred-texts.com" checked>www.sacred-texts.com  | 
 ...
 <!-- SiteSearch Google -->
 <hr>
 <p>You can also search the <a href="cat/index.htm">Catalog</a>:</p>
 ...
 <form action="cat/srchtitl.htm" method="GET" onsubmit="return validateForm(this)">
 <input type="SUBMIT" value="Search Titles">
 <input type="TEXT" width="400" name="search_str">
 </form>
 
 <form action="cat/srchauth.htm" method="GET" onsubmit="return validateForm(this)">
 <input type="SUBMIT" value="Search Authors">
 <input type="TEXT" width="400" name="search_str">
 </form>
 
 <form action="cat/srchsubj.htm" method="GET" onsubmit="return validateForm(this)">
 <input type="SUBMIT" value="Search Subjects">
 <input type="TEXT" width="400" name="search_str">
 </form>
 
 <form action="cat/random.htm" method="GET">
 <input type="SUBMIT" value="Random File">
 </form>
 <hr>
 
 <a href="cat/tkwidx.htm">Titles by Keyword</a><br>
 
 <a href="cat/akwidx.htm">Authors by Keyword</a><br>
 
 <a href="cat/skwidx.htm">Subjects by Keyword</a><br>
 
 <a href="cat/tlsidx.htm">Title List</a><br>
 
 <a href="cat/alsidx.htm">Author List</a><br>
 </center>
 </span><!-- ista-content -->
